...
tf.flags.DEFINE_string("training_file", "./data/traindata.csv", "training data file location (default: ./data/traindata.csv)")
tf.flags.DEFINE_integer("sentence_len", 200, "sentence length (default: 200)")
